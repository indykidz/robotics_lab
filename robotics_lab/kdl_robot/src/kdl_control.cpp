                                      ...
                                      double _Kdp, double _Kdo)
{
  ...
  /*  Eigen::Matrix<double,6,6> Kp, Kd;
    Kp.block(0,0,3,3) = _Kpp*Eigen::Matrix3d::Identity(); //matrix 3x3 error position
    Kp.block(3,3,3,3) = _Kpo*Eigen::Matrix3d::Identity(); //matrix 3x3 error orientation 
    Kd.block(0,0,3,3) = _Kdp*Eigen::Matrix3d::Identity(); //matrix 3x3 derivative of the position error 
    Kd.block(3,3,3,3) = _Kdo*Eigen::Matrix3d::Identity(); //matrix 3x3 error derivative orientation error
...
//    // compute linear errors - position and velocity
...
//    // compute orientation errors - orientation
